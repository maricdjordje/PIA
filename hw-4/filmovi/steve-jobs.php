                    ...
                    <div class="blog_left_sidebar">
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="../img/o-filmovima/jobs.jpg" alt="film">
                            ...
                            <div class="blog_details">
                                ...
                                <p>Novi film o neverovatnom vizionaru donosi nam zanimljive događaje koji su se događali iza pozornice prije lansiranja tri velika proizvoda, završavajući sa predstavljanjem iMac-a 1998. godine. Novi Stiv Džobs vodi nas iza scene digitalne revolucije kako bi oslikao intiman portret briljantnoga čoveka koji se nalazio u njezinom samom centru. Scenarij filma nastao je prema najprodavanijoj biografiji osnivača Applea, onoj autora Waltera Isaacsona.</p>
                        ...
                        <aside class="single_sidebar_widget post_category_widget">
                            ...
                            <ul class="list cat-list">
                                ...
                                <li>
                                        ...
                                        <p>Glumci: </p>
                                        <p>Majkl Fasbender, Kejt Vinslet, Set Rogen</p>
