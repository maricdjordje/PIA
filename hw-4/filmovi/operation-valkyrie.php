                    ...
                    <div class="blog_left_sidebar">
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="../img/o-filmovima/valkira.jpg" alt="film">
                            ...
                            <div class="blog_details">
                                ...
                                <p>Tom Kruz je pukovnik Klaus fon Štaufenberg, nemački aristokrata i oficir koji je predvodio herojski pokušaj svrgavanja nacističkog režima. Postavljanje bombe u Hitlerov bunker je bila jedna od najhrabrijih i najmanje poznatih epizoda iz Drugog svetskog rata. Operacija Valkira (engl. Valkyrie) je istorijski triler iz 2008. godine, radnjom smešten u nacističku Nemačku tokom Drugog svetskog rata. Film prikazuje Julsku zaveru nemačkih vojnih oficira čiji je cilj bilo ubistvo Adolfa Hitlera i pokretanje operacije Valkira za izvršenje nacionalnog plana za preuzimanje vlasti. </p>
                        ...
                        <aside class="single_sidebar_widget post_category_widget">
                            ...
                            <ul class="list cat-list">
                                ...
                                <li>
                                        ...
                                        <p>Scenario: </p>
                                        <p>Kristofer MekKveri</p>
                                    
                                </li>
                                <li>
                                    
                                        <p>Glumci: </p>
                                        <p>Tom Kruz, Bili Naji, Karis van Huten</p>
