                    ...
                    <div class="blog_left_sidebar">
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="../img/o-filmovima/tres.jpg" alt="film">
                            ...
                            <div class="blog_details">
                                ...
                                <p>Tema ovog filma jeste priča o svakodnevnom životu dvoje mladih i njihovih roditelja koji pokušavaju da se izbore za svoju ljubav i za sopstvenu sreću. Njih dvoje su potpuno različiti ali ipak se svim snagama bore za svoju ljubav.</p>
                        ...
                        <aside class="single_sidebar_widget post_category_widget">
                            ...
                            <ul class="list cat-list">
                                ...
                                <li>
                                        ...
                                        <p>Glumci: </p>
                                        <p>Mario Kasas, Maria Valverde, Alvaro Servantes</p>
