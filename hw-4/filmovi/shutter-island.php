                    ...
                    <div class="blog_left_sidebar">
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="../img/o-filmovima/shutter-island.jpg" alt="film">
                            ...
                            <div class="blog_details">
                                ...
                                <p>Dvojica američkih šerifa, Tedi Danijels (Leonardo Dikaprio) i Čak Ojl (Mark Rafalo), odlaze 1954. u psihijatrijsku bolnicu Ešklif na jednom izolovanom ostrvu blizu Masačusetsa sa zadatkom da istraže slučaj Rejčel Solando (Emili Mortimer), pacijentkinje koja je nestala iz zatvorene sobe. Psihijatar, dr Džon Koli (Ben Kingsli), šef odseka, objašnjava da je nestala pacijentkinja hospitalizovana nakon nervnog sloma koji je doživela kada joj se utopilo troje dece. Istražitelji nailaze na mnoge poteškoće, a Danijelsu jedne noći njegova bivša žena, koja je poginula u požaru, u snu saopštava da je Rejčel još živa. Kasnije istražitelji dolaze do otkrića da se u Ešklifu vrše interesantni eksperimenti, što sve zajedno pogubno deluje na Danijelsovu psihu.</p>
                        ...
                        <aside class="single_sidebar_widget post_category_widget">
                            ...
                            <ul class="list cat-list">
                                ...
                                <li>
                                        ...
                                        <p>Scenario: </p>
                                        <p>Laeta Kalogridis</p>
                                    
                                </li>
                                <li>
                                    
                                        <p>Glumci: </p>
                                        <p>Leonardo DiKaprio, Emili Mortimer, Mark Rafalo</p>
