                    ...
                    <div class="blog_left_sidebar">
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="../img/o-filmovima/loft.jpg" alt="film">
                            ...
                            <div class="blog_details">
                                ...
                                <p>Napeti psihološki triler o petorici muškaraca koji potajno iznajme stan u potkrovlju, gde mogu bez straha uživati u svojim tajnim aferama i ostvarivati svoje najveće fantazije. Međutim, fantazija postaje noćna mora kad u stanu zateknu mrtvo telo nepoznate žene te shvate da jedan od njih ima veze sa događajem. Obuzima ih paranoja budući da svaki od njih sumnja na svakoga, što dovodi u pitanje njihovo prijateljstvo i odanost. Istovremeno im se, pod pritiskom straha, sumnje i ubistva, počinju raspadati i brakovi.</p>
                        ...
                        <aside class="single_sidebar_widget post_category_widget">
                            ...
                            <ul class="list cat-list">
                                ...
                                <li>
                                        ...
                                        <p>Glumci: </p>
                                        <p>Karl Urban, Džejms Marsden, Ventvort Miler</p>
